...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    P.mb-5(data-aos="fade-left") Para la prevención y el control de plagas es fundamental conocer a qué tipo de plaga nos enfrentamos, que comportamiento tiene, conocer su ciclo biológico para así identificar las técnicas y los productos que podemos utilizar para su control. Conocer el medio, canales de desagüe, entradas a las bodegas, orificios, puertas mal cerradas, mal infraestructura o avería de la misma, todos estos factores influyen en el control y erradicación de dichos vectores, la limpieza de las áreas y el orden en los lugares de almacenamiento y trabajo. Las barreras físicas también hacen parte del control y erradicación de vectores logrando así que las plagas o vectores no ingresen a las diferentes áreas de producción.
      ...
      .col-lg-10
        .tarjeta--container.row.mb-5
          .col-md.tarjeta.color-acento-contenido.p-5
            ...
            h2.text-center Manuales
            p.text-center Los métodos manuales son todos los métodos que consisten en frotar, cepillar y rociar con agua a grandes presiones, donde se puede realizar un barrido húmedo, con escobas, cepillos, enjuagado, y tratamiento con espumas o geles.
    ...
    .row.justify-content-center.align-items-center
      .col-lg-10
        .tarjeta.p-4.mb-2(style="background-color:#FFFAD0")(data-aos="flip-up")
          .row.justify-content-center.align-items-center
            .col-lg-2.p-4
              figure
        ...
        .tarjeta.p-4.mb-5(style="background-color:#144677")(data-aos="flip-up")
          .row.justify-content-center.align-items-center
            ...
            .col
              .row.justify-content-center.align-items-center
                .col
                  p.text-small.text-white Para obtener más información sobre los productos de limpieza más utilizados dentro de los grupos de jabones y detergentes, se sugiere leer el Anexo I: “Guía para el desarrollo de normas de higienización de los piensos” (Fundación CESFAC, 2007), desde la página 97 hasta la 103.
                .col-sm-auto
                  a.boton.color-acento-contenido(href="https://cesfac.es/media/attachments/2019/08/08/guia-higienizacin.pdf" target="_blank")
                    span Enlace web
                    i.fas.fa-link
